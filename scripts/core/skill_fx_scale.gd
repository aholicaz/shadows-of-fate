## SkillFxScale — ขนาด "ภาพ" สกิลมอนเทียบกับขนาดตัว ★ รอบ 172 ★
##
## ใช้ 2 ที่:
...
## ค่าในไฟล์ .tres ของแต่ละตัวปรับไว้แล้วรอบ 172 (tools/round172_skillfx/fx_table.json) — ตัวนี้ไม่แก้ไฟล์
...
## สัดส่วน «ส่วนที่มีภาพ / ความสูงช่องเฟรม» ของชีทที่ใช้ร่วมกัน (วัดจากภาพจริงรอบ 172)
const FRAME_FILL := {
